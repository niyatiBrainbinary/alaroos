...
class GuestLoginScreen extends StatelessWidget {
   GuestLoginScreen({Key? key}) : super(key: key);
  final GuestLoginController guestLoginController =
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          guestLoginController.emailError.isNotEmpty
                              ? Text(guestLoginController.emailError,
                                  style: errorStyle)
                              : SizedBox(),
                          SizedBox(
                          ...
                          SizedBox(
                            ...
                            child: CommonTextField(
                              ...
                              controller:
                                  guestLoginController.passwordController,
                              keyboardType: TextInputType.visiblePassword,
                            ),
                          ),
                          guestLoginController.passwordError.isNotEmpty
                              ? Text(guestLoginController.passwordError,
                                  style: errorStyle)
                              : SizedBox(),
                          SizedBox(
                            ...
                            onTap: () {
                              ...
                              if (guestLoginController.validation()) {
                                guestLoginController.guestLoginApi(
                                    email: guestLoginController
                                        .emailController.text,
                                    password: guestLoginController
                                        .passwordController.text);
                              }
                              controller.emailController.clear(); controller.passwordController.clear();
